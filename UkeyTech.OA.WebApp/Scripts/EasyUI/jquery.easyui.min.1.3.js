...
(function ($) {
    ...
    function _378(_379) {
        ...
        var tipPos = $.data(_379, "validatebox").options.tipPosition;
        if (!tip) {
        ...
        //tip.css({display:"block",left:box.offset().left,top:box.offset().top+box.outerHeight()});


        if (tip && tipPos) {
            tip.find(".validatebox-tip-content").addClass("validatebox-tip-position-" + tipPos);
            tip.find(".validatebox-tip-pointer").addClass("validatebox-pointer-position-" + tipPos);

            if (tipPos == "top") {
                tip.css({ display: "block", left: box.offset().left, top: box.offset().top + box.outerHeight() });
            }
            else if (tipPos == "bottom") {
                tip.css({ display: "block", left: box.offset().left, top: box.offset().top - box.outerHeight() - 15 });
            }
            else {
                tip.css({ display: "block", left: box.offset().left + box.outerWidth(), top: box.offset().top });
            }
...
{ tipPosition: (t.attr("tipPosition") ? t.attr("tipPosition") : "top") });
    };
    $.fn.validatebox.defaults = { tipPosition: "top", required: false, validType: null, missingMessage: "This field is required.", invalidMessage: null, rules: { email: { validator: function (_387) {
...
(function ($) {
    ...
    $.fn.propertygrid.defaults = $.extend({}, $.fn.datagrid.defaults, { singleSelect: true, remoteSort: false, fitColumns: true, loadMsg: "", frozenColumns: [[{ field: "f", width: 16, resizable: false}]], columns: [[{ field: "name", title: "Name", width: 100, sortable: true }, { field: "value", title: "Value", width: 100, resizable: false}]], showGroup: false, groupField: "group", groupFormatter: function (_5ef, rows) {
        return _5ef;
    } 
    });
})(jQuery);
...
(function ($) {
    ...
    $.fn.combobox.defaults = $.extend({}, $.fn.combo.defaults, { valueField: "value", textField: "text", mode: "local", method: "post", url: null, data: null, keyHandler: { up: function () {
        ...
        var nq = q.replace(/(^\s*)|(\s*$)/g, "");
        return row[opts.textField].indexOf(nq) > -1;
...
(function ($) {
    function _782(_783) {
        ...
        _784.spinner.timespinner({ showSeconds: opts.showSeconds, separator: opts.timeSeparator }).unbind(".datetimebox").bind("mousedown.datetimebox", function (e) {
            e.stopPropagation();
        });
    ...
    $.fn.datetimebox.parseOptions = function (_79a) {
        var t = $(_79a);
        return $.extend({}, $.fn.datebox.parseOptions(_79a), $.parser.parseOptions(_79a, ["timeSeparator", { showSeconds: "boolean"}]));
    };
...
(function ($) {
        ...
        function _7ab(aa) {
            ...
            for (var i = 0; i < aa.length; i++) {
                ...
                if (aa[i] != "|") {
                    ...
                    span.html(aa[i]);
                    if (opts.mode == "h") {
                        span.css({ left: _7ad, marginLeft: -Math.round(span.outerWidth() / 2) });
                    } else {
                        span.css({ top: _7ad, marginTop: -Math.round(span.outerHeight() / 2) });
                    }
                }
            }
        };
    ...
    function _7ae(_7af) {
        ...
        _7b0.find("a.slider-handle").draggable({ axis: opts.mode, cursor: "pointer", disabled: opts.disabled, onDrag: function (e) {
    ...
    $.fn.slider = function (_7c5, _7c6) {
        ...
        return this.each(function () {
            ...
            if (_7c7) {
                ...
                _7c7 = $.data(this, "slider", { options: $.extend({}, $.fn.slider.defaults, $.fn.slider.parseOptions(this), _7c5), slider: init(this) });
                $(this).removeAttr("disabled");
            }
            _7ae(this);
            _7a8(this);
    ...
    $.fn.slider.parseOptions = function (_7ca) {
        var t = $(_7ca);
        return $.extend({}, $.parser.parseOptions(_7ca, ["width", "height", "mode", { showTip: "boolean", min: "number", max: "number", step: "number"}]), { value: (t.val() || undefined), disabled: (t.attr("disabled") ? true : undefined), rule: (t.attr("rule") ? eval(t.attr("rule")) : undefined) });
    };
    $.fn.slider.defaults = { width: "auto", height: "auto", mode: "h", showTip: false, disabled: false, value: 0, min: 0, max: 100, step: 1, rule: [], tipFormatter: function (_7cb) {
        return _7cb;
