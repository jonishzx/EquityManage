...
(function (factory) {
    ...
    function makeMoment(args, parseAsUTC, parseZone) {
        ...
        if (moment.isMoment(input)) {
            ...
            if (isNativeDate(input) || input === undefined) {
                mom = moment.apply(null, args)
            } else {
                isAmbigTime = false;
                isAmbigZone = false;
                if (isSingleString) {
                    if (ambigDateOfMonthRegex.test(input)) {
                        ...
                        if ((ambigMatch = ambigTimeOrZoneRegex.exec(input))) {
    ...
    function commonlyAmbiguate(inputs, preserveTime) {
        ...
        for (i = 0; i < len; i++) {
            ...
            if (!preserveTime && anyAmbigTime && !mom._ambigTime) {
                ...
                if (anyAmbigZone && !mom._ambigZone) {
        ...
        getHtmlRenderer: function (rendererName, rowType) {
            ...
            if (specificName && (renderer = view[specificName])) {
                ...
                if (specificName && (renderer = this[specificName])) {
                    ...
                    if ((renderer = view[generalName])) {
                        provider = view
                    } else {
                        if ((renderer = this[generalName])) {
                            provider = this
                        }
                    }
                }
            ...
            $.each({
                ...
                mousedown: function (seg, ev) {
                    if ($(ev.target).is(".fc-resizer") && view.isEventResizable(seg.event)) {
                        ...
                        if (view.isEventDraggable(seg.event)) {
                ...
                cellOver: function (cell, isOrig, origCell) {
                    ...
                    if (resizeLocation) {
                        if (!calendar.isEventRangeAllowed(resizeLocation, event)) {
                            ...
                            if (resizeLocation.start.isSame(event.start) && resizeLocation.end.isSame(eventEnd)) {
                                resizeLocation = null
                            }
                        }
                    }
    ...
    TimeGrid.mixin({
        ...
        compareForwardSlotSegs: function (seg1, seg2) {
            return seg2.forwardPressure - seg1.forwardPressure || (seg1.backwardCoord || 0) - (seg2.backwardCoord || 0) || this.compareSegs(seg1, seg2)
        }
    });
    ...
    function Calendar_constructor(element, overrides) {
        ...
        function prev() {
            if (typeof (changeMonthEvent) != "undefined" && !changeMonthEvent(currentView.computePrevDate(date)))
                return false;
                    ...
                    $.each(this.split(","), function (j, buttonName) {
                        ...
                        if (buttonName == "title") {
                            ...
                            if ((customButtonProps = (calendar.options.customButtons || {})[buttonName])) {
                                ...
                                if ((viewSpec = calendar.getViewSpec(buttonName))) {
            ...
            for (i = 0; i < peerEvents.length; i++) {
                ...
                if (eventIntersectsRange(peerEvent, range)) {
                    if (overlap === false) {
                        ...
                        if (typeof overlap === "function" && !overlap(peerEvent, event)) {
                            return false
                        }
                    }
                    if (event) {
