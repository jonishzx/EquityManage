...
<script runat="server">
    ...
    {
        m_strBasePath = "~/upload/News/Media";
        Response.Expires = 0;
        if (IsPostBack)
        {
            HandlePostBack();
    ...
    {
        return System.Text.RegularExpressions.Regex.IsMatch(strExt, "wmv|swf|ra|rm|qt|asf|flv", RegexOptions.IgnoreCase);
    }
...
<head>
    ...
    function deleteDir(obj)
    {
      ...
      function showPreview(src) {  
        //选择当前文件
        var hidspan = $("span:[href='" + encodeURI(src) + "']");    
