<%@ Page Language="C#" MasterPageFile="~/Areas/Admin/Views/Shared/AdminList.Master"
    Title="用户流程任务委托" Inherits="System.Web.Mvc.ViewPage" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Scripts" runat="server">
    ...
    <script type="text/javascript" src="<%=Url.Content("~/ModuleJs/WorkFlow/UserBizAssign.js")%>"></script>
    <script type="text/javascript">
        var baseurl = '<%=Url.Action("","AdminUser")%>';
    </script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div id="center" region="west" title="业务列表" style="width: 500px;">
        <table id="DataGrid">
        </table>
    </div>
    <div id="right" region="center" title="用户委托列表" style="width: 400px">
   ...
   <div id="Dialog" style="display: none;">
       <%-- <div class="easyui-layout" fit="true">--%>
            <div region="north" style="height:35px;">
               <div class="SearchDiv">
                    代码或名称：<input type="text" id="tbUserNameOrCode" style="width: 120px;" />
            ...
            <div region="south" border="false" style="height: 70px;">
                <div class="SouthForm form-action">
                    <div>
                        委托开始日期：<input id="StartAppDate" name="StartAppDate" type="text" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'});" style="width: 130px !important"
                            class="form-item-text Wdate" value="<%= DateTime.Now.ToString("yyyy-MM-dd 00:00")%>"
                            maxlength="16" />
                    ~
                        委托结束日期：<input id="EndAppDate" name="EndAppDate" type="text" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'});" style="width: 130px !important"
                            class="form-item-text Wdate" value="<%= DateTime.Now.AddDays(3).ToString("yyyy-MM-dd 18:00")%>"
                            maxlength="16" />
                    </div>
