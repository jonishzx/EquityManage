...
<head id="Head1" runat="server">  
    ...
    <script type="text/javascript" src="<%=Url.Content("~/ModuleJs/Permission/FunctionDataRule.js")%>"></script>
    <script type="text/javascript" src="<%=Url.Content("~/Scripts/common.min.js")%>"></script>
</head>
<body>
    <div class="SearchDiv">
        代码或名称：<input type="text" id="txtCodeOrName" style="width: 120px;" />
        <a href="javascript:void(0);" class="easyui-linkbutton" icon="icon-search" onclick="LoadFuncDataRuleGrid($('#txtCodeOrName').val());">
            查询</a>
    </div>
    <div class="easyui-layout">
        <div id="center" region="center" title="数据权限列表" style="width: auto;">
            <table id="tbFuncDataRule">
            </table>
        </div>
    </div>
    ...
    <script type="text/javascript" language="javascript">
        ...
        var baseurl = '<%=Url.Action("","Permission")%>';
        var DataRuleList = baseurl + "/GetAllFuncDataRuleList";
        var DeleteUrl = baseurl + "/DeleteFuncDataRule";
