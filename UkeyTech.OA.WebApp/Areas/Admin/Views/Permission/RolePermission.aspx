...
<body>
    <div class="SearchDiv">
        ...
        <a href="javascript:void(0);" class="easyui-linkbutton" icon="icon-search" onclick="LoadRoleGrid($('#txtCode').val(), $('#txtName').val());">
            查询</a> --%>
        <a href="javascript:void(0);" class="easyui-linkbutton" icon="icon-config" onclick="PopupClonePermission();">克隆权限</a>
    </div>
    <div class="easyui-layout" style="margin: 5px;">
        ...
        <div id="center" region="center" title="模块" style="width: auto;">
        ...
        <div id="east" region="east" split="true" title="功能" style="width: 10px;">
            <div class="easyui-layout" fit="true">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function LoadModuleGrid() {
            ...
            $('#tbModule').treegrid({
                ...
                idField: 'ModuleID',
                queryParams: { OwnerCode: hiddenOwnerTitle, OwnerValue: hiddenOwnerValue },
                columns: [[
